...
const ProductDetail = () => {
  ...
  return (
    <div className="w-full mx-auto py-10 mb-12 px-8 lg:px-16 font-poppins flex flex-col gap-10">
      <div className="basis-[50%] flex flex-col gap-6 lg:gap-4">
        ...
        <div className="relative flex justify-center items-center bg-[--bgSoft] rounded-md w-full h-[300px] lg:h-[500px] overflow-hidden">
          <Image
            src={product.image}
      ...
      <div className="basis-[50%] flex flex-col gap-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-2 mt-6 items-start sm:items-center text-base">
          <button className="bg-blue-700 text-white px-3 py-2 rounded-md text-[13px] shadow">
